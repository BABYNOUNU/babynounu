export const Seed_AgesOfChildren = [
  {
    name: 'Nourrisson',
    example: '0-12 mois',
    description:
...
const specificNeeds = [
  {
    ...
    description:
      'Surveillance alimentaire stricte pour éviter les réactions allergiques.',
  },
  {
  ...
  },
  {
    ...
    description:
      "Adaptation de l'environnement pour éviter les surcharges sensorielles.",
  },
  {
    ...
    description:
      'Surveillance et approche bienveillante pour répondre aux besoins comportementaux.',
  },
  {
  ...
  },
  {
    ...
    description:
      "Planification d'activités en fonction des capacités physiques.",
  },
  {
    name: 'Problèmes de sommeil',
    examples: ['Sommeil agité', 'Terreurs nocturnes', 'Réveil fréquent'],
    description:
      'Routine de sommeil ou assistance pour les aider à mieux dormir.',
  },
  {
    ...
    description:
      "Encouragement de l'indépendance et apprentissage des compétences de vie.",
  },
];
