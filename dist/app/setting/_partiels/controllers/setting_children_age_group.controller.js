...
exports.SettingChildrenAgeGroupController = void 0;
...
let SettingChildrenAgeGroupController = class SettingChildrenAgeGroupController {
    settingGeneraleService;
    settingChildrenAgeGroupRepository;
    constructor(settingGeneraleService, settingChildrenAgeGroupRepository) {
        this.settingGeneraleService = settingGeneraleService;
        this.settingChildrenAgeGroupRepository = settingChildrenAgeGroupRepository;
    }
    GetSettings() {
        return this.settingGeneraleService.settings(this.settingChildrenAgeGroupRepository);
    }
    GetSetting(slug) {
        return this.settingGeneraleService.setting(this.settingChildrenAgeGroupRepository, { slug });
    }
    CreateSetting(settingGuardScheduleBody) {
        return this.settingGeneraleService.createSetting(this.settingChildrenAgeGroupRepository, { createSettingBody: settingGuardScheduleBody });
    }
    UpdateSetting(settingGuardScheduleBody, slug) {
        return this.settingGeneraleService.updateSetting(this.settingChildrenAgeGroupRepository, { updateSettingBody: settingGuardScheduleBody }, { slug });
    }
    DeleteSetting(slug) {
        return this.settingGeneraleService.deleteSetting(this.settingChildrenAgeGroupRepository, { slug });
    }
};
exports.SettingChildrenAgeGroupController = SettingChildrenAgeGroupController;
__decorate([
    (0, common_1.Get)(''),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], SettingChildrenAgeGroupController.prototype, "GetSettings", null);
__decorate([
    (0, common_1.Get)('/:slug'),
