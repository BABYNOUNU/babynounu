...
const parent_settring_specific_skill_model_1 = require("../parent/models/parent_settring_specific_skill.model");
...
const parent_settring_area_work_model_1 = require("../parent/models/parent_settring_area_work.model");
const parent_setting_desired_time_model_1 = require("../parent/models/parent_setting_desired_time.model");
const parent_setting_age_of_children_model_1 = require("../parent/models/parent_setting_age_of_children.model");
const parent_setting_localization_model_1 = require("../parent/models/parent_setting_localization.model");
const parent_setting_languages_model_1 = require("../parent/models/parent_setting_languages.model");
...
exports.ParentProviders = [
    ...
    },
    {
        ...
        useFactory: (dataSource) => dataSource.getRepository(parent_setting_languages_model_1.ParentSettingLanguages),
        inject: ['DATA_SOURCE'],
    },
    {
        provide: 'PARENT_SETTING_SPECIFIC_NEEDS_REPOSITORY',
        useFactory: (dataSource) => dataSource.getRepository(parent_settring_specific_skill_model_1.ParentSettingSpecificSkills),
        inject: ['DATA_SOURCE'],
    },
    {
        provide: 'PARENT_SETTING_LOCALIZATION_REPOSITORY',
        useFactory: (dataSource) => dataSource.getRepository(parent_setting_localization_model_1.ParentSettingLocalizations),
        inject: ['DATA_SOURCE'],
    },
    {
        provide: 'PARENT_SETTING_AGE_OF_CHILDRENS_REPOSITORY',
        useFactory: (dataSource) => dataSource.getRepository(parent_setting_age_of_children_model_1.ParentSettingAgeOfChildrens),
        inject: ['DATA_SOURCE'],
    },
    {
        provide: 'PARENT_SETTING_DESIREDTIMES_REPOSITORY',
        useFactory: (dataSource) => dataSource.getRepository(parent_setting_desired_time_model_1.ParentSettingDeriredTimes),
        inject: ['DATA_SOURCE'],
    },
    {
        provide: 'PARENT_SETTING_AREA_WORK_REPOSITORY',
        useFactory: (dataSource) => dataSource.getRepository(parent_settring_area_work_model_1.ParentSettingAreaWork),
        inject: ['DATA_SOURCE'],
    },
    {
