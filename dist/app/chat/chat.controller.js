...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtenir l’historique d’un chat' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Historique du chat retourné' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Lister toutes les conversations' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Liste des conversations retournée' }),
    __metadata("design:type", Function),
